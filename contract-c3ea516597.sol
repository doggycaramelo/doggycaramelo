...
/// @custom:security-contact cachorrocaramelo@mail.com
contract CARAMEL is ERC20, ERC20Burnable, ERC20Pausable, AccessControl, ERC20Permit, ERC20Votes, ERC20FlashMint {
        ...
        ERC20Permit("CARAMEL")
    {
        ...
        _mint(msg.sender, 701701701701701 * 10 ** decimals());
